...
import za.co.wethinkcode.controller.Loadgame;
...
public class Window extends javax.swing.JFrame {
    ...
    za.co.wethinkcode.model.Map map;
    ...
    private void fightButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fightButtonActionPerformed
        ...
        if (fightResult == 0) {
            ...
            System.out.println(fight.droppedArtifact);
            if (fight.droppedArtifact == 1) {
                card.show(MainPanel, "equipDiscard");
            }
    ...
    private void heroStats() {
        ...
        stats += "Experience: " + myHero.getXp() + "/" + myHero.neededXP + "\n";
        stats += "Artifact: " + myHero.getArtifact() + "\n";
